...
public class Utilidad {
    ...
    private static final String RUTA_ARCHIVO = System.getProperty("user.home") + File.separator + "archivo_veterinaria" + File.separator;
    ...
    public static void escribirArchivoPerros(ArrayList<Perro> listaPerros) {
        try {
            ...
            for (Perro perro : listaPerros) {
                linea.append(perro.getNombre()).append(",");
                linea.append(perro.getEdad()).append(",");
                linea.append(perro.getPeso()).append(",");
                linea.append(perro.getRaza()).append(",");
                linea.append(perro.getDueno()).append(",");
                linea.append(perro.getEnergia()).append(",");
                linea.append(perro.getTamano()).append(",");
                linea.append(perro.getColor()).append(",");
                linea.append(perro.isCola()).append("|");
            }
            validarRuta();
    ...
    public static void escribirArchivoGatos(ArrayList<Gato> listaGatos) {
        try {
            ...
            for (Gato gato : listaGatos) {
                linea.append(gato.getNombre()).append(",");
                linea.append(gato.getEdad()).append(",");
                linea.append(gato.getPeso()).append(",");
                linea.append(gato.getRaza()).append(",");
                linea.append(gato.getDueno()).append(",");
                linea.append(gato.getEnergia()).append(",");
                linea.append(gato.isPelo()).append(",");
                linea.append(gato.isGarras()).append("|");
            }
            validarRuta();
